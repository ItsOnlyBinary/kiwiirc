...
import AvailableLocales from 'locale:available';
import FallbackLocale from 'locale:dev';
...
function initLocales() {
    ...
    // Build in the dev translation so it can be used as a fallback
    ...
    const setDefaultLanguage = () => {
        ...
        for (let idx = 0; idx < preferredLangs.length; idx++) {
            ...
            if (_.includes(AvailableLocales, lang.toLowerCase())) {
