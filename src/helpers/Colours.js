...
/**
 * Converts a hex CSS colour value to RGB.
...
/**
 * Converts an RGBA colour value to a hex string.
...
/**
 * Converts an RGB colour value to HSL. Conversion formula adapted from
...
/**
 * Converts an HSL colour value to RGB. Conversion formula adapted from
 * http://en.wikipedia.org/wiki/HSL_color_space. This function adapted
 * from http://stackoverflow.com/a/9493060.
...
/**
 * Converts an HSL colour object to hsl string
 *
 * @param   {Object}  hsl     HSL as h, s, l and a [optional] as keys
 * @return  {String}          string in the format hsl(0, 0, 0) or hsla(0, 0, 0, 1)
 */
...
/**
 * Converts an RGB colour object to rgb string
 *
 * @param   {Object}  rgb     RGB as r, g, b and a [optional] as keys
 * @return  {String}          string in the format rgb(0, 0, 0) or rgba(0, 0, 0, 1)
 */
...
/**
 * Parses hex or rgba string to RGBA colour object
 *
 * @param   {String}  rgb     RGB as r, g, b and a [optional] as keys
 * @return  {Object}          an rgba object
 */
