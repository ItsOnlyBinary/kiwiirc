<template>
    <div class="kiwi-settings-aliases">
        ...
        <div v-if="show_help" class="kiwi-settings-aliases-help">
            <div>Aliases let you rename existing IRC commands or even build entirely new ones.</div>
            <div>
            ...
            <p>You can also use variables to read input from the typed command.</p>
            <ul>
            ...
            <p>
                ...
                username" will execute "/msg username Hello, username!".
            </p>
            <p>
