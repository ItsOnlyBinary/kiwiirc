...
const tests = [
    ...
    // },
    // {
    //     html: '<p dir="ltr"><span style="color: var(--irc-colour-04); white-space: pre-wrap;">testtest</span><span style="color: var(--irc-colour-04); background-color: var(--irc-colour-01); white-space: pre-wrap;">test</span></p>',
    //     irc: '\x0304testtest\x0304,01test',
    // },
    {
        html: '<p dir="ltr"><span style="white-space: pre-wrap;">test </span><span style="color: var(--irc-colour-04); white-space: pre-wrap;">test </span><span style="color: var(--irc-colour-04); background-color: var(--irc-colour-01); white-space: pre-wrap;">test</span><span style="color: var(--irc-colour-04); white-space: pre-wrap;"> test </span><span style="color: var(--irc-colour-04); background-color: var(--irc-colour-01); white-space: pre-wrap;">test </span><span style="color: var(--irc-colour-03); background-color: var(--irc-colour-01); white-space: pre-wrap;">test</span></p>',
        irc: 'test \x0304test \x0304,01test\x03\x0304 test \x0304,01test \x0303test',
    },
    {
